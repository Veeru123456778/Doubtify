...
const Hero = ({ stopOnClick, question }) => {
  ...
  const handleAnswerClick = (e) => {
    ...
    setShowAnswerPopup(true);
    // setTimeout(() => {
      // setLoading(false); // Hide spinner and show "Answer" text
    //   setShowAnswerPopup(true); // Show the answer popup
    // }, 2000);
        ...
        <div>
          ...
          <div className="flex flex-row items-center justify-between sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center mb-2 sm:mb-0">
              <button
                onClick={handleAnswerClick}
                className="text-blue-600 mr-2 px-4 py-1 font-bold bg-blue-100 rounded-lg"
              >
                {load?
