...
const DropdownComponent = ({category,subCategory,setCategory,setSubCategory}) => {
    ...
    return (
        <div className="flex-col sm:flex sm:flex-row gap-6 2xl:w-12">
            ...
            <div className="mb-4">
                <label className={`block text-sm font-bold mb-2 ${isDarkTheme ? 'text-[#E0E0E0]' : 'text-gray-700'}`} htmlFor="subcategory">
                    Subcategory
                </label>
                <div className="relative">
                    {loadingSubcategories ? (
                        ...
                        <select
                            ...
                            className={`block appearance-none w-64 xl:w-80 2xl:w-96 border  p-2 rounded shadow leading-tight focus:outline-none focus:shadow-outline ${isDarkTheme ? 'bg-[#323B4A] text-[#E0E0E0] border-[#404b5a]' : 'bg-white border-gray-400 hover:border-gray-500'}`}
                            disabled={!category}
                        >
